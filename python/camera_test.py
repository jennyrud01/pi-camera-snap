        ...
        try:
            while True:
                ...
                for i in range(20):
                    ...
                    file_name = '/home/pi/rpi-deep-pantilt/temp/image{0:04d}.jpg'.format(i)
                    print("Capturing {}".format(file_name))
                    camera.capture(file_name, use_video_port=True)
                    camera.wait_recording(.3)
                print("Making GIF")
                os.system('convert -delay 10 -loop 0 /home/pi/rpi-deep-pantilt/temp/image*.jpg animation.gif')
